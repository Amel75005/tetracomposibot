...
class Robot_player(Robot):
    ...
    def step(self, sensors, sensor_view=None, sensor_robot=None, sensor_team=None):
        ...
        if self.iteration % self.it_per_evaluation == 0:
                if self.iteration > 0:
                    #fitness = somme des translations effectives mesurees pendant l evaluation
                    score = self.log_sum_of_translation
                    print("\tfitness, la somme des translations =", score)
                    ...
                    if score > self.bestScore:
                        ...
                        print("meilleur score =", self.bestScore, "params =", self.bestParam)
                #nouvelle startegie aleatoire
                self.param = [random.randint(-1, 1) for i in range(8)]
