...
class Robot_player(Robot):
    ...
    def step(self, sensors, sensor_view=None, sensor_robot=None, sensor_team=None):
        ...
        front = active_front
        #rotation hate on fuit les robots cest l inverse de love
        rotation = (right - left)*1.0
        #translation pour ralentir quand un robot est proche
        translation = 0.6 + 0.6 *(front+active_front_left+active_front_right)
        #on borne
